...
// Google blocks OAuth in WebViews (Error 403: disallowed_useragent)
// So we hide Google Sign-In in Capacitor app, show only Phone OTP
function useIsApp() {
        ...
        >
          ...
          {step === 'phone' ? (
            <>
              ...
              {/* Google Sign-In — hidden in Capacitor app (Google blocks OAuth in WebViews) */}
              {!isApp && (
                <>
